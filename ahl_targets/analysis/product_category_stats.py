...
def product_category_report(cat_data: pd.DataFrame, file_name: str, category: str):
...
if __name__ == "__main__":
    ...
    store_sub_df = product_category_report(
        store_sub_prods, "store_subset_store_info", "store_cat"
    )
    # store subset products - manufacturer
    store_sub_manuf_df = product_category_report(
        manuf_store_sub_prods, "store_subset_manuf_info", "manufacturer"
    )
    # store
    store_df = product_category_report(prod_purch_df, "store_info", "store_cat")
    # manufacturer
