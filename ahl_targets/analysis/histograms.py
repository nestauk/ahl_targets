...
plt.title("Unweighted Energy Density Distribution")
plt.savefig(
...
plt.title("Kcal weighted distribution")
plt.savefig(
...
# Add a vertical line
plt.axvline(
    x=(weighted_data["ed"] * weighted_data["kg_w"]).sum() / weighted_data["kg_w"].sum(),
    color="r",
    linestyle="--",
)  # Replace `value` with the desired position of the line
plt.axvline(
...
plt.title("Kg weighted distribution")
plt.savefig(
...
plt.title("Product weighted distribution")
plt.savefig(
